...
/**
 * Minimal chat markdown: fenced code, inline code, bold, bullet lists, and
 * @NAME mentions rendered as pills with the employee's avatar.
 */
...
function Inline({ text, team }: { text: string; team: Team }) {
  ...
  const pattern = new RegExp(`(\`[^\`]+\`|\\*\\*[^*]+\\*\\*${mention ? `|${mention}` : ''})`, 'gi')
